...
const HpBars: React.FC = () => {
  ...
  const hpBarFirstPlayer = useCallback((g: any) => {
    ...
    g.drawRect(stageProps.width * 0.01 + 5, stageProps.height * 0.02 + 5, hpBarLength(hpBarFirstMonster, firstSelectedMonster.max_HP), 20);
    g.endFill();
    ...
    g.beginFill(0x00ff00);
    g.drawRect(stageProps.width * 0.01 + 5, stageProps.height * 0.1 + 5, hpBarLength(hpBarSecondMonster, secondSelectedMonster.max_HP), 20);
    g.endFill();
    //ThirdPoke
    g.beginFill(0x000000);
    ...
    g.beginFill(0x00ff00);
    g.drawRect(stageProps.width * 0.01 + 5, stageProps.height * 0.18 + 5, hpBarLength(hpBarThirdMonster, thirdSelectedMonster.max_HP), 20);
    g.endFill();
  ...
  const hpBarSecondPlayer = useCallback((g: any) => {
    ...
    g.beginFill(0x00ff00);
    g.drawRect(stageProps.width * 0.80 + 5, stageProps.height * 0.02 + 5, hpBarLength(hpBarFirstEnemyMonster, firstSelectedEnemyMonster.max_HP), 20);
    g.endFill();
    ...
    g.beginFill(0x00ff00);
    g.drawRect(stageProps.width * 0.80 + 5, stageProps.height * 0.1 + 5, hpBarLength(hpBarSecondEnemyMonster, secondSelectedEnemyMonster.max_HP), 20);
    g.endFill();
    //sixthPoke
    g.beginFill(0x000000);
    ...
    g.beginFill(0x00ff00);
    g.drawRect(stageProps.width * 0.80 + 5, stageProps.height * 0.18 + 5, hpBarLength(hpBarThirdEnemyMonster, thirdSelectedEnemyMonster.max_HP), 20);
    g.endFill();
