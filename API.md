...
| moveUser | Изменить координаты игрока (перемещение) |
| getMap | Возвращает данные о карте из БД |
| updateScene | Возвращает данные о пользователях в игре |
| getAllLots | возвращает список всех лотов, если пользователь находится в городе |
| getCatalog | возвращает список всех предложений торговца, если пользователь находится в городе |
...
### 4.12. getCatalog <!---поменять номер в девелопе-->
