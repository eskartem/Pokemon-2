...
5.5.1.2. Покемон 1.2. Скилл - Глыбопад: Обрушивает на врага массивные камни, нанося 120% урона. Если цель уже находится под действием отрицательного эффекта, урон увеличивается на 20%.
Статистика:
Урон: 120
Здоровье: 480
Защита: 50
...
5.5.1.4. Покемон 1.4. Скилл - Гравитационная волна: Изменяет локальную гравитацию, увеличивая вес врагов, что наносит им 25% от урона покемона на протяжении 5 секунд. Дополнительно увеличивает урон на 10%, если покемон противника тяжелее.
Статистика:
Урон: 70
Здоровье: 520
Защита: 55
...
5.5.2.1. Покемон 2.1. Скилл - Ледяной шквал: Водный покемон выпускает ледяные иглы в цель, нанося урон с шансом заморозить противника на 1 ход. Если цель заморожена, следующий удар нанесет вдвое больше урона.
Статистика:
Урон: 100
Здоровье: 450
Защита: 40
...
5.5.2.3. Покемон 2.3. Скилл - Волна разрушения: Сильная водная атака, которая наносит 120% урона цели и 50% от этого урона всем ближайшим противникам. Если цель была ослаблена до атаки, ближайшие враги получают полный урон.
Статистика:
Урон: 120
Здоровье: 500
Защита: 55

5.5.2.4. Покемон 2.4. Скилл - Водоворот: Создает водоворот, наносящий 100% урона каждый ход в течение 3 ходов. Урон увеличивается на 10% за каждый ход, если противник не покидает зону действия.
Статистика:
Урон: 100
Здоровье: 470
Защита: 50
...
5.5.3.1. Покемон 3.1. Скилл - Испепеляющий удар: Мощная огненная атака, которая наносит 140% урона и вызывает статус "горение", наносящий урон с каждым ходом. Урон от горения увеличивается, если цель уже горит.
Статистика:
Урон: 140
Здоровье: 510
Защита: 45

5.5.3.2. Покемон 3.2. Скилл - Фениксова искра: Маленький огненный шар, который при попадании взрывается и наносит 110% урона. Если цель погибает от атаки, взрыв наносит урон всем ближайшим врагам (70% от начального урона).
Статистика:
Урон: 110
Здоровье: 480
Защита: 50

5.5.3.3. Покемон 3.3. Скилл - Огненная буря: Поднимает огненную бурю, наносящую 120% урона по всем врагам в зоне. С каждым ударом увеличивает шанс критического удара на 5% до конца битвы.
Статистика:
Урон: 120
Здоровье: 530
Защита: 60

5.5.3.4. Покемон 3.4. Скилл - Пепельный взрыв: Атакует с мощным взрывом огня, нанося 150% урона по одной цели. Если враг был под эффектом "горения", урон увеличивается на 50%.
Статистика:
Урон: 150
Здоровье: 550
Защита: 65
...
5.5.4.1. Покемон 4.1. Скилл - Удар ветра: Выпускает поток сжатого воздуха, нанося 130% урона одной цели. Если цель использовала атаку в предыдущий ход, урон увеличивается на 20%.
Статистика:
Урон: 130
Здоровье: 470
Защита: 40

5.5.4.2. Покемон 4.2. Скилл - Штормовой порыв: Приземляет врага мощной воздушной атакой, нанося 110% урона, с дополнительным уроном (до +30%) за каждый успешный уклон покемона в предыдущих ходах.
Статистика:
Урон: 110
Здоровье: 460
Защита: 45

5.5.4.3. Покемон 4.3. Скилл - Воздушный клинок: Выпускает острую волну воздуха, наносящую 120% урона по всем врагам в линии. Каждая пораженная цель увеличивает вероятность следующей воздушной атаки нанести критический удар.
Статистика:
Урон: 120
Здоровье: 490
Защита: 55

5.5.4.4. Покемон 4.4. Скилл - Циклон разрушения: Создает мощный воздушный вихрь, нанося 150% урона цели. Если цель находится в воздухе (например, после использования воздушных атак), урон увеличивается на 30%.
Статистика:
Урон: 150
Здоровье: 520
Защита: 60
...
5.5.5.1. Победитель получает 30% монет, 10% покемонов (понижается его уровень) и 20% кристаллов стихий проигравшего.
...
10.8.1. Экран "Инвентарь" предоставляет игроку доступ ко всем имеющимся покемонам, позволяет улучшать их, просматривать статистику и выбирать трех покемонов, которые будут участвовать в сражениях.

10.8.2. Все покемоны, находящиеся во владении игрока, отображаются в инвентаре.

10.8.3. 3 покемона, которые участвуют в сражениях, находятся сверху. Все остальные покемоны снизу. Между ними можно сделать отделяющую черту.

#### 10.8.4. Основные функции инвентаря
...
- **Результат**: После подтверждения улучшений статистика покемона обновляется, и ресурсы игрока расходуются.
...
### 10.8.7. Дополнительные элементы

10.8.7.1. **Индикатор ресурсов**
