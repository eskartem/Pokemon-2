...
9.1.1. 500 монет  
9.1.2. 3 покемона (огонь, вода, земля) 1 уровня
...
9.2.2.2. Максимальная длина сообщения: **256 символов**. 9.3.2.3. Сообщения, превышающие ограничение по длине, не отправляются, а игроку показывается сообщение об ошибке ("Лимит символов в сообщении: 256").
...
9.2.3.5. Если перед нажатием "Enter" зажать "Shift", произойдет снос строки в поле с сообщением.
